---
title: "Raiku Security Model: Nine Layers of Protection"
sidebarTitle: "Security Overview"
description: "Raiku protects installs with schema validation, forbidden pattern scanning, SHA-256 hash verification, safe mode approval, restricted subprocess environments, and build timeouts."
---
