---
title: "raiku doctor — Check Build Tool and Environment Health"
sidebarTitle: "Doctor"
description: "raiku doctor checks that required build tools are installed and accessible, reporting versions and install hints for each missing tool per language."
---
