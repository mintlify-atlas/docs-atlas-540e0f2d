---
title: "raiku cache — Manage and Inspect the Local Package Cache"
sidebarTitle: "Cache"
description: "raiku cache shows disk usage and installed package count with --info, or wipes the entire local cache with --clear. Default path is ~/.raiku/cache/."
---
