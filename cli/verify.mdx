---
title: "raiku verify — Re-verify One Installed Package Hash"
sidebarTitle: "Verify"
description: "raiku verify re-checks the SHA-256 integrity of one installed package against the index. Use raiku audit to scan all packages at once."
---
