---
title: "Raiku CLI Reference: All Commands and Global Options"
sidebarTitle: "Overview"
description: "Full reference for every Raiku CLI command. Global options apply to all subcommands, spanning package operations, authoring, inspection, and maintenance."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Package Authoring" icon="pen-to-square" href="/cli/init">
    Commands for creating, validating, and publishing packages: init, validate, publish.
  </Card>
  <Card title="Inspection & Utilities" icon="magnifying-glass" href="/cli/list">
    Explore what is installed and why: list, info, outdated, diff, why, graph.
  </Card>
  <Card title="Maintenance" icon="wrench" href="/cli/audit">
    Keep your cache healthy: audit, verify, repair, rollback, doctor.
  </Card>
  <Card title="Configuration & Tools" icon="gear" href="/cli/config">
