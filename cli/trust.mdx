...
sidebarTitle: "trust"
description: "raiku trust marks packages as trusted, skipping the safe-mode build confirmation prompt on future installs. Trust is always an explicit user action, never automatic."
---
