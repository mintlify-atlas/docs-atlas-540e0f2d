...
sidebarTitle: "login"
description: "raiku login stores a GitHub personal access token for use with raiku publish --submit. Use raiku whoami to confirm the stored identity and logout to clear it."
---
