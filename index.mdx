...
sidebarTitle: "Home"
description: "Raiku is an open, Git-based package manager supporting Python, Rust, C, C++, Zig, Java, C#, and Go — with built-in hash verification and safe-mode builds."
---
